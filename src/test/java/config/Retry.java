...
public class Retry extends browsers.BeforeAfter implements IRetryAnalyzer {
	 // set counter to 0
	...
	public boolean retry(ITestResult result ) {
		try {
			...
			e.printStackTrace();
			logger.log(LogStatus.FAIL, "following test is failing "+ result.getName()+"Retry is "+(minretryCount+1));
		}
		return false ;
	}
